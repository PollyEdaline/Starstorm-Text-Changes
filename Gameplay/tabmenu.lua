...
-- INFO
	...
	local specialInfo = {
		...
		{name = "Spikestrip", maxStack = nil, info = "Drop spikestrips on getting hit. Spikestrips slow enemies by 20%, and bleed them for 25% damage.", stackInfo = "increases duration."},
		...
		{name = "Needles", maxStack = 49, info = "4% chance to mark enemies on hit for 100% Critical Strike chance. Lasts 3 seconds.", stackInfo = "+2% mark chance."},
		...
		{name = "Roulette", maxStack = nil, info = "Get a random, temporary stat buff each minute.", stackInfo = "increases buff value by 50%."},
		...
		{name = "Voltaic Gauge", maxStack = nil, info = "Slaying elites drops orbs that grant 15 temporary shield.", stackInfo = "+10 shield."},
		...
		{name = "Sticky Overloader", maxStack = 7, info = "Attacking an enemy charges damage by 32%, up to 800%. Damage is dealt after the enemy is not attacked for 1 second.", stackInfo = "Increases damage charge by 32%."},
		...
		{name = "Droid Head", maxStack = nil, info = "Spawns a helping drone for 11 seconds after slaying boss enemies.", stackInfo = "+4 seconds."},
		...
		{name = "Relic of Force", maxStack = nil, info = "All skills deal an extra attack for 100% damage, BUT increases cooldown duration by 40%.", stackInfo = "stacks multiplicatively."},
		...
		{name = "Stirring Soul", maxStack = 1, info = "Slain enemies leave a soul. Souls have a chance of turning into items on contact.", stackInfo = "Doesn't stack."},
