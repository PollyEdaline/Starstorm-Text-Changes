...
CHEF = {"Excellence in cooking is the &y&CHE'sF&!& specialty. It can acquire the right ingredients even in the least familiar environments.", {{"Strength", 5}, {"Vitality", 5}, {"Toughness", 3}, {"Agility", 5}, {"Difficulty", 5}, {"Cuisine", 8}}},
...
Technician = {"On the UES Contact Light, things frequently go wrong. The &y&Technician&!& can fix problems, as long as he doesn't create more in the process.", {{"Strength", 4}, {"Vitality", 5}, {"Toughness", 3}, {"Agility", 4}, {"Difficulty", 6}, {"Service", 7}}},
