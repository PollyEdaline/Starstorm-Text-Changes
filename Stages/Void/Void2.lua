...
local STAGE_BACKGROUNDS = {
	[11000] = {"VoidStars2", "Starstorm", 1, 1, 1, 1, 0, 0, 0, 0 },
...
callback.register("globalRoomStart", function(rm)
	if rm == room then
		obj.TeleporterFake:create(792, 464).visible = false
		if net.host then
		...
		local chest1 = obj.ItemChest:create(1004, 992)
		chest1:getData().id = 1
		local chest2 = obj.ItemChest:create(1058, 992)
		chest2:getData().yoffset = 12
		chest2:getData().id = 2
		local chest3 = obj.ItemChest:create(1112, 992)
		chest3:getData().id = 3
		
		runData["traderChest1"].set = false
		runData["traderChest2"].set = false
		runData["traderChest3"].set = false
