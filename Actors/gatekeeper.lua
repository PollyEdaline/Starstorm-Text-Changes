...
local sprPortrait = Sprite.load("GatekeeperPortrait", path.."Portrait", 1, 119, 119)
...
mlog.Gatekeeper.story = "Civilized constructs in this environment are scarce, most creatures are completely feral, but the Gatekeepers are advanced in every way observable.\nThey have an impressive royal demeanor, protecting adorned teleporters and scaring fauna away. Unlike the Guards I found in the temple, their armor is remarkably tough and their intelligence makes me doubt whether they are completely mechanical or some kind of hybrid.\n\nThey aren't easy to take down, hampering my progress. Defeating them is a major relief as they can be extremely dangerous: they hunker down to defend themselves and shoot with extreme precision at any target in their vision.\n\nIf there is any way I can avoid having to confront them I will take it. I can feel my chances of survival getting slimmer for each time I see one..."
mlog.Gatekeeper.statHP = 800
mlog.Gatekeeper.statDamage = 24
mlog.Gatekeeper.statSpeed = 0.7
mlog.Gatekeeper.sprite = Sprite.load("GatekeeperLogbook", path.."Logbook", 20, 37, 54)
