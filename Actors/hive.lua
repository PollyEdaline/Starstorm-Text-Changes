...
mlog.ArcherBugHive.story = "The root of the plague, endlessly spitting out Archer Bugs. The only way to stop them from crawling out is destroying all the Hives. It is likely that they are connected, forming a supercolony.\n\nThese insects seem to lay their eggs anywhere they can. I can regularly see young Grubs sliding out of the Hive's cavities, leaving an astoundingly sticky substance behind. Could it be to protect the Hive from unwanted visitors?\n\n..It absolutely keeps me away."
mlog.ArcherBugHive.statHP = 1000
