...
obj.Eye:addCallback("create", function(self)
	...
	selfAc.damage = 22 * Difficulty.getScaling("damage")
...
mlog.Overseer.story = "It is during a moment of peace that I find this extraordinary outlier: the Overseer watches, calmly hidden behind a distant rock formation as I shelter myself for the storm brewing in the horizon.\nRaindrops start falling from the sky as I stare back, and it takes notice, it has been caught, however, it doesn't move.\nNext thing I see is a pair of Imps rapidly approaching it, it blinks away the same way the Imps do. I turn around to hide and there it is, still attentive of my actions but just a few feet away from me. I feel threatened and can't take chances.. it's a duel.\n\nI can't help but wonder if it had good intentions. It's clear it's presence wasn't appreciated by the Imps, could it be an outcast of their family?"
mlog.Overseer.statHP = 1200
mlog.Overseer.statDamage = 22
mlog.Overseer.statSpeed = 1
mlog.Overseer.sprite = sprIdle
mlog.Overseer.portrait = sprPortrait